...
<html lang="pt-br">
    <head>
        ...
        <title>Banco de Investimeto Max</title>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">       
            <div class="navbar-header">
                <a class="navbar-brand" href="{{url('/')}}" 
                   title="Página Inicial" style="margin-top: -3px">
                    <img src="{{URL::asset('img/ima_mario2_novo.png')}}"></a>
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right" id="link-white">
                    <li class="dropdown">
                        <a href="#" style="text-decoration: none">
                            <img src="{{URL::asset('img/ima_mario.jpg')}}" 
                                 class="img-circle" width="26" height="26" 
                                 style="margin-top: -3px"> 
                            <span id="underline">Fernando Santos</span> 
                        </a>                      
                    </li>
                    <li><a href="{{url('/')}}"
                            ...
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Cidade</th>                
                                        <th id="center">Agência</th>
                                        <th id="center">Tipo de Aplicação</th>                
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td title="E-mail" id="center">{{$cliente->email}}</td>
                                        <td title="Cidade" id="center">{{$cliente->cidade}}</td>
                                        <td title="Agência" id="center">{{$cliente->agencia}}</td>
                                        <td title="Tipo de Aplicação" id="center">{{$cliente->tipo_aplicacao}}</td> 
