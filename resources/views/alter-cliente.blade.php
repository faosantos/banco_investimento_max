                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cidade" 
                                       class="form-control" 
                                       value="{{$client->cidade or old('cidade')}}"
                                       required>
                            </div>    
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="agencia" 
                                       class="form-control" 
                                       value="{{$client->agencia or old('agencia')}}"
                                       required>
                            </div>    
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="tipo_aplicacao" 
                                       class="form-control" 
                                       value="{{$client->tipo_aplicacao or old('tipo_aplicacao')}}"
                                       required>
                            </div>    
                        </div>                         
                        <div class="col-md-12">                   
